...
; Please fill the following out. Type may be one of get, git, bzr or svn,
; and url is the url of the download.
;projects[apachesolr_ubercart][download][type] = ""
;projects[apachesolr_ubercart][download][url] = ""
;projects[apachesolr_ubercart][type] = "module"

; Please fill the following out. Type may be one of get, git, bzr or svn,
; and url is the url of the download.
;projects[ecc2.7.2][download][type] = ""
;projects[ecc2.7.2][download][url] = ""
;projects[ecc2.7.2][type] = "module"

; Please fill the following out. Type may be one of get, git, bzr or svn,
; and url is the url of the download.
;projects[uc_registry][download][type] = ""
;projects[uc_registry][download][url] = ""
;projects[uc_registry][type] = "module"

; Mighty Nest Custom
projects[mightynest_custom][type] = module
projects[mightynest_custom][subdir] = custom
;projects[mightynest_custom][directory_name] = mightynest_custom
projects[mightynest_custom][download][type] = "git"
projects[mightynest_custom][download][url] = "git@sundaysenergy.unfuddle.com:sundaysenergy/custom.git"
...
projects[mightynest_review][download][url] = "git@sundaysenergy.unfuddle.com:sundaysenergy/review.git"

; Custom Theme

projects[mightynest][type] = theme
projects[mightynest][subdir] = custom
projects[mightynest][download][type] = git
projects[mightynest][download][url] = "git@sundaysenergy.unfuddle.com:sundaysenergy/mightynest.git"
